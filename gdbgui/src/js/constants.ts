...
const colorTypeMap = {} as Record<string, string>;
colorTypeMap[constants.console_entry_type.STD_OUT] =
    constants.xtermColors["reset"];
colorTypeMap[constants.console_entry_type.STD_ERR] =
    constants.xtermColors["red"];
colorTypeMap[constants.console_entry_type.SENT_COMMAND] =
    constants.xtermColors["lblue"];
