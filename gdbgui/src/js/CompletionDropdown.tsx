...
> {
        ...
        for (let i = 0; i < arr1_len; i++) {
            ...
            for (let j = 0; j < arr2_len; j++) {
                ...
                if (len_diff > 4 || len_diff < -4) {
                    ...
                    l =
                        this.get_damerau(fa, arr2_j) /
                        Math.max(arr2_j_len, fa_len);
                }
                if (l < best_l) {
                    best_l = l;
                    best_i = j;
            ...
            if (best_l >= cap) {
                ...
                current_match_score +=
                    15 * this.position_score(best_i, arr2_len);
    ...
    scroll_active_into_view() {
        const el = this.ulRef.current?.querySelector(
