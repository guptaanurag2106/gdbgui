...
The backend is written in Python and consists of a Starlette, uvicorn server with websocket capability.
...
The [pygdbmi library](https://github.com/cs01/pygdbmi) is used to manage the gdb subprocess and parse its output. It returns key/value pairs (dictionaries) that can be used to create a frontend.
